...
void __fastcall CIniFile::MachineFile(bool bRead)
{
  ...
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLaneTransportDelayTime",m_dLaneTransportDelayTime,15.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamSubDelayTime",m_dLamSubDelayTime,0.3);
  ...
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamHeight0",m_dLamHeight[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamHeight1",m_dLamHeight[1],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamStop0",m_dLamStop[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamStop1",m_dLamStop[1],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamGetPos0",m_dLamGetPos[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamGetPos1",m_dLamGetPos[1],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamVacHeight0",m_dLamVacHeight[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamVacHeight1",m_dLamVacHeight[1],0.0);

  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamSecondHeight0",m_dLamSecondHeight[0],10.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamSecondHeight1",m_dLamSecondHeight[1],10.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamSecondTime0",m_dLamSecondTime[0],1.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamSecondTime1",m_dLamSecondTime[1],1.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamThirdHeight0",m_dLamThirdHeight[0],1.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamThirdHeight1",m_dLamThirdHeight[1],1.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamThirdTime0",m_dLamThirdTime[0],60.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dLamThirdTime1",m_dLamThirdTime[1],60.0);

  DDXFile_Int(bRead,pIniFile,Machine_Section,"m_nAutoInterval",m_nAutoInterval,3);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dAutoStopRange",m_dAutoStopRange,2.0);

  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dPressCalRange",m_dPressCalRange,50.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dPressCalTime",m_dPressCalTime,5.0);
...
void __fastcall CIniFile::ProductFile(char *strFileName,bool bRead)
{
  ...
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX00",m_dLaserUpPosEndX[0][0],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY00",m_dLaserUpPosEndY[0][0],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX01",m_dLaserUpPosEndX[0][1],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY01",m_dLaserUpPosEndY[0][1],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX02",m_dLaserUpPosEndX[0][2],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY02",m_dLaserUpPosEndY[0][2],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX03",m_dLaserUpPosEndX[0][3],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY03",m_dLaserUpPosEndY[0][3],0.0);
  ...
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserDownPosEndX0",m_dLaserDownPosEndX[0],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserDownPosEndY0",m_dLaserDownPosEndY[0],0.0);
  ...
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX10",m_dLaserUpPosEndX[1][0],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY10",m_dLaserUpPosEndY[1][0],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX11",m_dLaserUpPosEndX[1][1],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY11",m_dLaserUpPosEndY[1][1],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX12",m_dLaserUpPosEndX[1][2],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY12",m_dLaserUpPosEndY[1][2],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndX13",m_dLaserUpPosEndX[1][3],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserUpPosEndY13",m_dLaserUpPosEndY[1][3],0.0);
  ...
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserDownPosEndX1",m_dLaserDownPosEndX[1],0.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLaserDownPosEndY1",m_dLaserDownPosEndY[1],0.0);
  ...
  DDXFile_Int(bRead,pIniFile,Product_Section,"m_nBoatType",m_nBoatType,0);
  ...
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dCoolDownTimeF",m_dCoolDownTimeF,5.0);
  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dCoolDownTimeR",m_dCoolDownTimeR,5.0);

  DDXFile_Float(bRead,pIniFile,Product_Section,"m_dLamSecondKeepTime",m_dLamSecondKeepTime,0);
