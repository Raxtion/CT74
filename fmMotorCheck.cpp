    ...
    : TForm(Owner)
{
    ...
    //Manual Logging
    AnsiString strShow = "手動控制: Motor Test. m_nActiveAxis=" + IntToStr(m_nActiveAxis);
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    {
        if (g_Motion.GetActualPos(AXIS_FL)>g_IniFile.m_dLamStop[1]+1) g_IniFile.m_nErrorCode = 98;
