...
void __fastcall CEQPXML::doQueryVID(char *pRx)
{
    ...
    strcpy(SVID[3], FormatFloat("0.0", 22.39/*g_IniFile.m_dLamTemp[1]*/).c_str());
    strcpy(SVID[4], FormatFloat("0.0", 0.0).c_str());
    strcpy(SVID[5], FormatFloat("0.0", 34.9/*g_IniFile.m_dLamPress[0]*/).c_str());
    strcpy(SVID[6], FormatFloat("0.0", 0.0).c_str());
    strcpy(SVID[7], FormatFloat("0.0", 22.0/*g_IniFile.m_dLamPress[1]*/).c_str());
    strcpy(SVID[8], FormatFloat("0.0", 0.0).c_str());
    strcpy(SVID[9], FormatFloat("0.0", 3.2094/*g_IniFile.m_dLamTime[0]*/).c_str());
